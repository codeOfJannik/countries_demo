...
class CountryInfoParser extends ApiResponseParser<CountryInfo?> {
  CountryInfoParser(this.country);
  final Country country;

  @override
  CountryInfo? parse(Map<String, dynamic>? json) {
    final countryData = json?[JsonKeys.country] as Map<String, dynamic>?;
    if (countryData == null) return null;
    return CountryInfo.forCountryWithJson(country, countryData);
  }
